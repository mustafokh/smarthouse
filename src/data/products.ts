...
export const products: Product[] = [
  ...
  {
    id: "YSL-001",
    slug: "yandex-layt-2-soatsiz",
    code: "YSL-001",
    name: "Yandex Layt 2 soatsiz",
    nameUz: "Yandex Layt 2 soatsiz",
    category: "kolonkalar",
    price: 60,
    currency: "USD",
    protocol: "yandex",
    ...
    shortDescription:
      "Yandex Layt 2 — soatsiz ixcham smart kolonka, Alice bilan.",
    description:
      "Yandex Layt 2 soatsiz — Alice ovozli yordamchi bilan ixcham smart kolonka. Soatsiz model, musiqa va smart uy bilan ishlaydi. 5 xil rangda.",
    specs: [
      "Yandex Alice",
      "Soatsiz",
      "Wi-Fi",
  ...
  {
    id: "YSL-002",
    slug: "yandex-layt-3-soatli",
    code: "YSL-002",
    name: "Yandex Layt 3 soatli",
    nameUz: "Yandex Layt 3 soatli",
    category: "kolonkalar",
    price: 70,
    currency: "USD",
    protocol: "yandex",
    colors: ["orange", "teal", "green", "pink", "purple"],
    shortDescription:
      "Yandex Layt 3 — old panelda LED soat, Alice smart kolonka.",
    description:
      "Yandex Layt 3 soatli — Alice ovozli yordamchi va old panelda LED soat. Musiqa, smart uy integratsiyasi. 5 xil rangda mavjud.",
    specs: [
      "Yandex Alice",
      "LED soat",
      "Wi-Fi",
    ...
    image: "/products/YSL-002.png",
    imagesByColor: {
      orange: "/products/YSL-002-orange.png",
      teal: "/products/YSL-002-teal.png",
      green: "/products/YSL-002-green.png",
      pink: "/products/YSL-002-pink.png",
      purple: "/products/YSL-002-purple.png",
    },
    featured: true,
  },
];
